  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="text-center mb-16">
        ...
        {session ? (
          <div className="mb-6">
            <p className="text-lg text-green-700 font-semibold dark:text-green-200">{t('welcome')}, {session.user?.name || session.user?.email}!</p>
          </div>
        ) : (
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center dark:bg-gray-800 dark:text-white">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-3 dark:text-gray-100">{t('interactive_map')}</h3>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center dark:bg-gray-800 dark:text-white">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-3 dark:text-gray-100">{t('current_status')}</h3>
          <p className="text-gray-600 dark:text-gray-300">
            {t('info_fill')}
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center dark:bg-gray-800 dark:text-white">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-3 dark:text-gray-100">{t('eco_community_tile')}</h3>
          <p className="text-gray-600 dark:text-gray-300">
            {t('share_tips')}
          </p>
        </div>
