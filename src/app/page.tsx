    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-3">Interaktivní mapa</h3>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-3">Aktuální stav</h3>
          <p className="text-gray-600">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-3">Eko komunita</h3>
          <p className="text-gray-600">
